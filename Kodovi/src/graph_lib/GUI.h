...
//------------------------------------------------------------------------------
    ...
    public:
		...
		Widget(Point xy, int w, int h, const string& s)
			: loc(xy), width(w), height(h), label(s)
		{}
		Widget(Point xy, int w, int h)
			: loc(xy), width(w), height(h)
		{}
		Widget(Point xy, int w, int h, Callback cb)
			: loc(xy), width(w), height(h), do_it(cb)
		{}
...
//------------------------------------------------------------------------------
	struct CheckBox : Widget {
		CheckBox(Point xy, int w, int h, const string& label, Callback cb)
			: Widget(xy, w, h, label, cb)
		{}
...
//------------------------------------------------------------------------------
	...
	struct Slider : Widget {
		Slider(Point xy, int w, int h, Callback cb)
			: Widget(xy, w, h, cb)
		{}
		void attach(Window&);
		void value(int i);
...
//------------------------------------------------------------------------------
	...
	struct Group :Widget {
		Group(Point xy, int w, int h, const string& label)
			: Widget(xy, w, h, label)
		{}
